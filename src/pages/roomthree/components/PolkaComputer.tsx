  ...
  return (
    <>
      {showObject ? (
        <div
          id="polka-computer"
          className="fixed top-0 left-0 right-0 bottom-0 z-50 bg-secondary md:absolute md:top-[10%] md:left-[80%] md:bottom-[10%] md:min-h-0 md:w-[350px] md:bg-transparent"
        >
          <div className="relative h-full overflow-hidden bg-secondary md:w-[330px] md:rounded-2xl md:border-b-[6px] md:border-b-accent md:p-4">
            <button
