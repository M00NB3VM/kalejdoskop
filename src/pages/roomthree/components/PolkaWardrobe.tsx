...
function PolkaWardrobe({ showObject, setShowObject }: Props) {
  useEffect(() => {
    const element = document.getElementById("polka-wardrobe");
  ...
  return (
    <>
      {showObject ? (
        <div
          id="polka-wardrobe"
          className="fixed top-0 left-0 right-0 bottom-0 z-50 bg-secondary md:absolute md:top-[15%] md:left-[50%] md:bottom-[50%] md:min-h-0 md:w-[350px] md:bg-transparent"
        >
