...
function LiamComputer({ showObject, setShowObject }: Props) {
  useEffect(() => {
    const element = document.getElementById("liam-computer");
  ...
  return (
    <>
      {showObject ? (
        <div
          id="liam-computer"
          className="fixed top-0 left-0 right-0 bottom-0 z-50 bg-secondary md:absolute md:top-[50%] md:left-[63%] md:bottom-[20%] md:min-h-0 md:w-[350px] md:bg-transparent"
        >
