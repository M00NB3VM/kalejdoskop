...
function MilouGift({ showObject, setShowObject }: Props) {
  useEffect(() => {
    const element = document.getElementById("milou-gift");
  ...
  return (
    <>
      {showObject ? (
        <div
          id="milou-gift"
          className="fixed top-0 left-0 right-0 bottom-0 z-50 bg-secondary md:absolute md:top-[6%] md:left-[40%] md:bottom-[15%] md:min-h-0 md:w-[350px] md:bg-transparent"
        >
