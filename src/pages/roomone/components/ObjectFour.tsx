...
function ObjectFour({ showObject, setShowObject }: Props) {
  return (
    <>
      {showObject ? (
        <div className="fixed top-0 left-0 right-0 bottom-0 z-40 overflow-auto md:absolute md:top-[55%] md:left-[53%] md:min-h-0 md:max-w-[290px]">
